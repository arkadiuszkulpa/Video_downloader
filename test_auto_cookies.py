"""Quick test - should auto-load cookies for Zoom"""
...
print("Testing auto-cookie loading for Zoom...")
print("Should automatically find and load zoom_cookies.json\n")

success, output_file, message = downloader.download(
    url=url,
    output_dir="dump/test2"
    # No cookies_file specified - should auto-load!
)
